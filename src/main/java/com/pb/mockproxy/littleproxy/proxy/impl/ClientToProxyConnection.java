package com.pb.mockproxy.littleproxy.proxy.impl;

import com.pb.mockproxy.littleproxy.proxy.*;
...
import static com.pb.mockproxy.littleproxy.proxy.impl.ConnectionState.*;
...
public class ClientToProxyConnection extends ProxyConnection<HttpRequest> {
    ...
    private boolean authenticationRequired(HttpRequest request) {
        ...
        byte[] decodedValue = Base64.getDecoder().decode(value.getBytes(Charset.forName("UTF-8")));
